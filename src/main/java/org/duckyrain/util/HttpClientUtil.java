...
public enum HttpClientUtil {
     ...
     * @return HttpEntity
     * */
    static HttpEntity partEntity(Map<String, String> body, String bodyAsString, CONTENT_TYPE contentType, Charset charset) throws UnsupportedEncodingException, NoSuchMethodException {
